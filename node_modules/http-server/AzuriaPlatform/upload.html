    ...
    function initPhotoUpload()
{
    ...
    {
        var file = _ifrPhoto.contentWindow.document.getElementById('file');
        ...
        if (!regExp.test(file.value)) //Somehow the expression does not work in Opera
        {
    ...
    _divUploadMessage.style.display = 'none';function photoUploadComplete(message, isError)
{
    ...
    if (message.length)
    {
        ...
        if (isError)
        {
            _ifrPhoto.contentWindow.document.getElementById('file').focus();
        }
    }
}
    _divFrame.style.display = '';

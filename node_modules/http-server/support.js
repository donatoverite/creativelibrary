var c,ctx,maxWidth,lineHeight,x,y;c=document.getElementById('canvas');ctx=c.getContext('2d');maxWidth=window.innerWidth;lineHeight=36;x=25;y=36;function clear(){ctx.clearRect(0,0,c.width,c.height)}
